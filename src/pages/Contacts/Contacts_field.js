  ...
  return (
    <div className="contact_main">
      ...
      <div className="purple_container map_info">
        ...
        <p>
          Based in France, I am perfectly positioned to collaborate with clients both locally and internationally. Whether you are close by or across the globe, I offer flexible working modes — be it fully remote or a balanced hybrid approach.
        </p>
      </div>
    </div>
  );
